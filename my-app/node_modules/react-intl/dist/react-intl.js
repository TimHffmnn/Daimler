...
(function (global, factory) {
    ...
    */
    // -- Utilities ----------------------------------------------------------------
    function getCacheId$1(inputs) {
      return JSON.stringify(inputs.map(function (input) {
        return input && _typeof(input) === 'object' ? orderedProps$1(input) : input;
      }));
    }

    function orderedProps$1(obj) {
      return Object.keys(obj).sort().map(function (k) {
        var _a;
    ...
    var memoizeFormatConstructor$1 = function memoizeFormatConstructor(FormatConstructor, cache) {
      if (cache === void 0) {
        cache = {};
      }
    ...
    */
    ...
    function createFormatters() {
      ...
      return {
        getDateTimeFormat: memoizeFormatConstructor$1(Intl.DateTimeFormat, cache.dateTime),
        getNumberFormat: memoizeFormatConstructor$1(Intl.NumberFormat, cache.number),
        getMessageFormat: memoizeFormatConstructor$1(IntlMessageFormat, cache.message),
        getRelativeTimeFormat: memoizeFormatConstructor$1(Intl.RelativeTimeFormat, cache.relativeTime),
        getPluralRules: memoizeFormatConstructor$1(Intl.PluralRules, cache.pluralRules)
      };
    }
